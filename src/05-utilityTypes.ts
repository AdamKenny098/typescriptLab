...
import { Friend, Colleague, SecureFriendContact, FriendPartial, EventPass, Buddy } from "./myTypes";
...
//https://www.geeksforgeeks.org/typescript/typescript-picktype-keys-utility-type
type Combo = Pick<Friend,"name" | "age"> & Pick<Colleague, "contact">;
